...
$q1 = "select count(*) as vaccine_category from category";
$res1 = mysqli_query($con, $q1);
$data1 = mysqli_fetch_assoc($res1);


$q2 = "select count(*) as hospitals from users where role_id_FK='3'";
$res2 = mysqli_query($con, $q2);
$data2 = mysqli_fetch_assoc($res2);


$q3 = "select count(*) as parents from users where role_id_FK='2'";
$res3 = mysqli_query($con, $q3);
$data3 = mysqli_fetch_assoc($res3);

$q4 = "select count(*) as vaccine from vaccine_detail";
...
<div class="st-content ">
  ...
  <div class="hero-first ">
    <div id="back">
      <div class="img-container">
        <img src="assets/img/slide-hero2.jpg" alt="">
        <img src="assets/img/slide-hero1.jpg" alt="">

        <img src="assets/img/slide-hero3.jpg" alt="">
      </div>
      ...
      <div class="row">
        <div class="col-lg-4" id="card">
          <div class="st-iconbox st-style1">
            ...
            <h2 class="st-iconbox-title"><a href="">Our Hospitals</a></h2>
            <div class="st-iconbox-text">We have city's best hospitals registered</div>
          </div>
        ...
        <div class="col-lg-4" id="card">
          <div class="st-iconbox st-style1">
            ...
            <h2 class="st-iconbox-title"><a href="">Vaccines</a></h2>
            <div class="st-iconbox-text">We have almost all disease vaccines available.</div>
          </div>
          <div class="st-height-b0 st-height-lg-b30"></div>
        </div><!-- .col -->
      </div>
  ...
  <section id="vaccine">
    ...
    <div class="container">
      <div class="st-section-heading st-style1">
        <h2 class="st-section-heading-title">Vaccine</h2>
    ...
    <div class="container">
      ...
      <div class="st-slider st-style2">
        ...
        data-slides-per-view="responsive" data-xs-slides="1" data-sm-slides="2" data-md-slides="3" data-lg-slides="4" data-add-slides="4">
          <div class="slick-wrapper">
            <?php while ($data5 = mysqli_fetch_assoc($res5)) { ?>
              <div class="slick-slide-in">
                <div class="st-member st-style1 st-zoom">
                  <div class="st-member-img">
                    <a class="st-doctor-link" href="appointment_form.php?id=<?php echo $data5['ID'] ?>"><i class="fas fa-link"></i></a>
                  ...
                  <div class="st-member-meta">
                    <div class="st-member-meta-in">
                      <h3 class="st-member-name"><a href="vaccine.php?id=<?php echo $data5['ID'] ?>"><?php echo $data5['CAT_NAME'] ?></a></h3>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <div class="invi">
    <section id="animated-text" style="width:100%;overflow:hidden;display:flex;padding:5% ">
      <h1 style="font-size: 20vw; white-space:nowrap ;color :black ; font-weight: 500;">VACCINATION MANAGEMENT SYSTEM</h1>
    </section>
  </div>
          ...
          <div class="row animit">
            <div class="col-lg-6">
              <div class="st-funfact st-style1">
                ...
                <h2 class="st-funfact-number st-counter"><?php echo $data1['vaccine_category'] ?></h2>
                <div class="st-funfact-title">Vaccines Category</div>
              </div>
            ...
            <div class="col-lg-6">
              <div class="st-funfact st-style1">
                ...
                <h2 class="st-funfact-number st-counter"><?php echo $data3['parents'] ?></h2>
                <div class="st-funfact-title">Our Users</div>
              </div>
              <div class="st-height-b30 st-height-lg-b30"></div>
            </div><!-- .col -->
            <div class="col-lg-6">
              <div class="st-funfact st-style1">
                ...
                <h2 class="st-funfact-number st-counter"><?php echo $data4['vaccine'] ?></h2>
                <div class="st-funfact-title">Available Vaccines</div>
              </div>
              <div class="st-height-b30 st-height-lg-b30"></div>
            </div><!-- .col -->
            <div class="col-lg-6">
              <div class="st-funfact st-style1">
                <div class="st-funfact-icon st-dip-blue-box">
                  <svg enable-background="new 0 0 511.619 511.619" viewBox="0 0 511.619 511.619" xmlns="http://www.w3.org/2000/svg">
                    <g>
                ...
                <h2 class="st-funfact-number st-counter"><?php echo $data2['hospitals'] ?></h2>
                <div class="st-funfact-title">Our Hospitals</div>
              </div>
              <div class="st-height-b30 st-height-lg-b30"></div>
            </div><!-- .col -->
          </div>
        </div>
        <div class="col-xl-6 animit2  ">
          <div class="st-video-block st-style1 st-zoom">
            ...
            <a href="vaccine_single.php" class="st-play-btn st-style1 st-video-open">
        ...
        <div class="col-lg-6 faqss">
          ...
          <div class="st-accordian-wrap">
            <div class="st-accordian active ">
              ...
              <div class="st-accordian-body">VMS is vaccination booking system, you can book your appointment</div>
            </div><!-- .st-accordian -->
            <div class="st-accordian">
              ...
              <div class="st-accordian-body">To book an appointment you need to <a href="login.php">login</a> first,
                Add your child details then book an appointment. </div>
            </div><!-- .st-accordian -->
            <div class="st-accordian">
              <div class="st-accordian-title">
                Are all kind of vaccine available?
                <span class="st-accordian-toggle fa fa-angle-down"></span>
              </div>
              <div class="st-accordian-body">To some extent we have vaccines available of many disease/infection such as polio,covid and more.</div>
            </div><!-- .st-accordian -->
